# This scripts extracts FC7 features from iCubWorld28 via an Imagenet- or iCubWorld28-trained Caffemodel
...
features=np.array(np.zeros([25831,4096]))
...
scipy.io.savemat('/home/niklas/Downloads/GURLS/gurls/demo/train_data/fc7.mat', mdict={'fc7_data': features})
scipy.io.savemat('/home/niklas/Downloads/GURLS/gurls/demo/train_data/classnrs.mat', mdict={'classnrs': true_classNumbers_list})
