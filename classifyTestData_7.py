...
caffe_root = '/home/niklas-karinne/Downloads/caffe/'  # this file is expected to be in {caffe_root}/../Documents/Python\ Scripts/examples
import sys
...
import os
if not os.path.isfile(caffe_root + 'models/bvlc_reference_caffenet_iCubWorld28/caffenet_train_iter_12120.caffemodel'):
...
net = caffe.Net(caffe_root + 'models/bvlc_reference_caffenet_iCubWorld28/deploy.prototxt',
                caffe_root + 'models/bvlc_reference_caffenet_iCubWorld28/caffenet_train_iter_12120.caffemodel',
                caffe.TEST)
...
# Reading filenames
filename_txt=open('/home/niklas-karinne/Desktop/textfiles/test_filenames.txt','r')
true_classNumbers_txt=open('/home/niklas-karinne/Desktop/textfiles/test_TRUE_classNumbers.txt','r')
...
test_predictedNumbers_txt=open('/home/niklas-karinne/Desktop/textfiles/test_predictedNumbers.txt','w')
...
#test_classNumbers_txt=open('/home/niklas-karinne/Desktop/textfiles/test_predictedNumbers.txt','r')
